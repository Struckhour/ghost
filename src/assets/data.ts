const fullData: { [gameName: string]: {[scopeName: string]: {[rifleName: string]: (number | string)[]}} } = {
  Breakpoint: {
    ...
    'DUAL RANGE': {
        ...
        'MK14':[100,200,245,275,300,335,370,400,],
        'MK14 BALLISTIC ADVANTAGE':[150,275,438,550,],
        "MK14 MAWL-DA": [125, 200, 275, 313, 350, 400, 450],
        "MK14 MAWL-DA +30 RANGE": [125, 263, 375, 450, 563],
        'MK14 RANGE FINDER':[100,213,288,338,388,438,500,550,],
        ...
        'MSR':[],
        'MSR RANGE FINDER':[175,275,350,400,463,550,613,688,750,788,825,],
    ...
    'TARS101': {
        ...
        'MK14':[100,213,260,295,330,365,405,440,475,500,530,550,570,585,605,620,630],
        ...
        'MSR RANGE FINDER':[175,263,338,400,463,538,600,663,713,763,800,825,863,888,900],
        'RECON-A1':[150,233,290,340,395,450,505,558,600],
    ...
    'VC16': {
      ...
      '416 SCOUT BALLISTIC ADVANTAGE':[75,200,275,350,475,675,950,'greater than 1000'],
      ...
      'G28 BALLISTIC ADVANTAGE':[125,300,400,513,700,'greater than 1000',],
      'G28 MAWL-DA':[125,200,250,300,355,460,600,],
      'G28 RANGE FINDER':[125,200,260,310,390,500,670,],
      'G28 SCOUT':[100,155,170,190,213,238,275,300,438,],
      'G28 SCOUT BALLISTIC ADVANTAGE':[100,213,263,325,413,525,725,800,],
      'G28 WILDERNESS':[125,175,230,260,310,380,480,533,],
      'G28 WILDERNESS BALLISTIC ADVANTAGE':[125,300,400,513,700,'greater than 1000',],
      ...
      'M110 BALLISTIC ADVANTAGE':[125,225,325,425,525,750,1000,],
      ...
      'M4A1 SCOUT MAWL-DA BALLISTIC ADVANTAGE':[100,250,325,425,575,863,'GREATER THAN 1000',],
      'M4A1 SCOUT RANGE FINDER':[100,175,200,238,300,363,475,],
      M82:[150,238,288,338,388,463,588,650],
      'MK14':[150,200,225,238,263,300,338,363,513,],
    ...
    'ACSS': {
      ...
      'M4A1 SCOUT RANGE FINDER':[100,175,225,288,375,488,625],
    ...
    'DIGITAL': {
      ...
      'AK47 SHORTY BALLISTIC ADVANTAGE':[88,163,263,400,600,800,],
      'AK47 SHORTY RANGE FINDER':[88,125,188,250,325,425,],
      ...
      'G28 SCOUT BALLISTIC ADVANTAGE':[100,200,300,463,650,838,],
      ...
      'M4A1 TACTICAL RANGE FINDER':[88,138,207,300,400,525,],
      ...
      'MK17 ASSAULT RANGE FINDER':[100,175,275,400,575,725,],
    ...
    'SLX5': {
      ...
      '553 SCOUT':[75,100,200,250,350,500,638],
      '553 SCOUT MAWL-DA':[75,150,225,300,425,600,775],
      ...
      'G28 SCOUT':[],
      'G28 SCOUT MAWL-DA':[100,163,213,250,300,388,475,],
      ...
      'SCORPION EVO3':[55,125,163,200,275,375,475],
      'SCORPION EVO3 CQC':[50,100,130,160,200,260,335],
    ...
    'TA31H': {
      ...
      '416 SCOUT':[75,138,175,225,263,338,450,],
      '416 SCOUT MAWL-DA':[100,150,200,250,313,413,563],
      ...
      'ACR ASSAULT':[100,125,163,200,250,325,438,],
      'ACR ASSAULT BALLISTIC ADVANTAGE':[100,213,300,400,588,850,'greater than 1000',],
      ...
      'MK17':[100,175,225,263,325,425,550],
      'MK17 BALLISTIC ADVANTAGE':[100,300,400,550,825],
      'MK17 MAWL-DA':[100,188,250,300,400,525,675],
      'MK17 MAWL-DA +30 RANGE':[100,250,350,450,650,888,],
      'MK17 MAWL-DA BALLISTIC ADVANTAGE':[100,350,475,700],
      'MK17 RANGE FINDER':[100,200,275,325,425,575,738],
      'MK17 RANGE FINDER BALLISTIC ADVANTAGE':[125,350,500,775],
      'MK17 ASSAULT':[100,175,213,250,300,388,500],
      'MK17 ASSAULT BALLISTIC ADVANTAGE':[100,275,375,500,750,1000],
      'MK17 ASSAULT MAWL-DA':[100,200,250,300,350,475,613],
      'MK17 ASSAULT MAWL-DA BALLISTIC ADVANTAGE':[100,350,450,588,900],
      'MK17 ASSAULT RANGE FINDER':[100,200,250,300,388,513,663],
      'MK17 ASSAULT RANGE FINDER BALLISTIC ADVANTAGE':[113,300,488,650,1000],
...
// SHOTGUNS
  ...
  Wildlands: {
    'TA31H': {
      ...
      'G28':[100,175,238,263,338,413,500],
      'G28 RANGE FINDER':[138,200,250,288,363,438,525],
      'G28 LONG BARREL':[150,213,275,325,413,525,638],
      'G28 LONG BARREL RANGE FINDER':[175,238,300,350,450,550,663],
      ...
      'MK16':[100,138,188,200,250,300,388],
      'MK16 RANGE FINDER':[100,150,188,225,263,325,400,],
      'MK16 LONG BARREL':[100,150,200,250,300,375,475,],
      'MK16 LONG BARREL RANGE FINDER':[125,175,225,263,325,400,500],
      'MK16 SHORT BARREL':[100,125,150,175,200,233,275,],
      'MK16 SHORT BARREL RANGE FINDER':[100,125,166,180,225,263,300],
    ...
    'TARS101': {
      ...
      'M40A5 LONG BARREL':[150,225,300,425,550,663,763,850,925],
      ...
      'MSR ZOOMED':[175,238,288,375,450,538,613,675,738,788,825],
      'MSR':[163,213,250,325,388,450,513,588],
    ...
    'T5XI TACTICAL': {
      ...
      'L115A3 LONG BARREL':[100,238,350,600,850],
      ...
      'MSR LONG BARREL':[175,275,350,575,788,925],
