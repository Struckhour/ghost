const fullData: { [gameName: string]: {[scopeName: string]: {[rifleName: string]: (number | string)[]}} } = {
  Breakpoint: {
    ...
    'DUAL RANGE': {
        ...
        "553 SCOUT MAWL-DA": [100, 150, 225, 300, 350, 425, 525, 625],
  ...
  Wildlands: {
    ...
    'POSP': {
      ...
      'HIS AK47 ZOOMED':[150,175,200,225,250,275,375,425,575,600,],
      'HIS AK47':[125,150,175,200,225,250,300,325,450,475,],
      'L115A3':[],
      'MK14 ZOOMED':[175,200,250,300,375,450,625,650,],
      'MK14':[150,175,225,250,300,325,450,475,675,700,],
      'MK14 OCCULT ZOOMED':[300,350,450,500,625,],
      'MK14 OCCULT ':[275,325,400,450,500,550,],
      'PSG-1 ZOOMED':[150,200,225,250,300,325,425,450,600,650,],
      'PSG-1':[125,150,200,225,250,275,325,350,475,500,],
