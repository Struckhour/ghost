const fullData: { [gameName: string]: {[scopeName: string]: {[rifleName: string]: (number | string)[]}} } = {
  Breakpoint: {
    ...
    'DIGITAL': {
      ...
      416:[75,125,175,225,288,363,],
      '416 MAWL-DA':[75,125,188,257,338,450,],
      '416 RANGE FINDER':[88,138,200,275,375,500],
      ...
      'MK17 ASSAULT':[100,150,225,313,425,538,],      
  ...
  Wildlands: {
    'TA31H': {
      ...
      'AUG LONG BARREL RANGE FINDER':[125,175,275,325,475,625,775],
    ...
    'DIGITAL': {
      ...
      'MK17':[100,150,200,300,425,550],
      'MK17 SHORT BARREL':[100,125,175,250,325,425,],
      'MK17 LONG BARREL':[100,150,250,375,550,700,],
