const fullData: { [gameName: string]: {[scopeName: string]: {[rifleName: string]: (number | string)[]}} } = {
  Breakpoint: {
    ...
    'DUAL RANGE': {
        ...
        'G28 SCOUT WOLVES BALLISTIC ADV.':[125,225,375,488,600,],
    ...
    'DIGITAL': {
      ...
      'FAL BALLISTIC ADV.':[100,175,275,450,675,863],
      ...
      'MK14 ASSAULT BALLISTIC ADV.':[225, 270, 400, 600, 850],
    ...
    'TA31H': {
      ...
      'FAL BALLISTIC ADV.':[100,200,250,325,425,600,800],
    ...
    'RU LONG-RANGE': {
      ...
      'SVD-63 BALLISTIC ADV.': [188,	400,	600,	],
